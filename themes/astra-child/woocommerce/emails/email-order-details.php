...
<?php
// Проверка: есть ли в заказе товары под заказ
$has_backorder = false;
...
if ( $has_backorder ) {
	echo '<p style="color:#e67e22; font-size:16px; margin-top:10px;"><strong>' . esc_html__( 'Товар замовлено на пошиття. Термін виготовлення 15-25 робочих днів.', 'astra' ) . '</strong></p>';
}
?>
